...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-phone_number', __webpack_require__(3));
  Vue.component('detail-phone_number', __webpack_require__(6));
  Vue.component('form-phone_number', __webpack_require__(9));
});
